        ...
        <>
            ...
            {open && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    />
                    <div className="relative bg-card text-card-foreground border border-border rounded-xl shadow-2xl p-6 max-w-md w-full animate-in zoom-in-95 fade-in duration-200">
                        ...
                        <div className="mt-6 pt-4 border-t border-border">
                            <button
                                onClick={() => setOpen(false)}
                                className="w-full bg-primary text-primary-foreground py-2 rounded-xl text-sm font-medium hover:opacity-90 transition-opacity"
                            >
                                Done
                            </button>
                        </div>
